...
export default function Cgu() {
  return (
    <main>
      <h1>CGU</h1>
      <div className="cgu">
        <div className="cgu__description">
          <h2 className="cgu__description__h2">
            Conditions Générales d'utilisation
          </h2>
          <p className="cgu__description__content">
        ...
        <div className="cgu__section">
          ...
          <p className="cgu__section__content">
            ...
            relatives aux droits d'auteur et aux marques. Vous n'êtes pas
            autorisé à reproduire, modifier, distribuer ou exploiter ces
            contenus sans une autorisation écrite préalable.
          </p>
        </div>
        <div className="cgu__section">
          <h3 className="cgu__section__h3">Utilisation du site :</h3>
          <p className="cgu__section__content">
        ...
        <div className="cgu__section">
          <h3 className="cgu__section__h3">Liens vers des sites tiers :</h3>
          <p className="cgu__section__content">
            Ce site peut contenir des liens vers des sites web tiers. Ces liens
            sont fournis uniquement pour votre commodité et ne constituent pas
            une approbation ou une garantie de ces sites. Nous déclinons toute
            responsabilité quant au contenu ou à la sécurité de ces sites tiers.
            L'accès à ces sites se fait à vos propres risques.
          </p>
        </div>
        <div className="cgu__section">
          <h3 className="cgu__section__h3">Limitation de responsabilité :</h3>
          <p className="cgu__section__content">
        ...
        <div className="cgu__section">
          <h3 className="cgu__section__h3">Modifications des CGU :</h3>
          <p className="cgu__section__content">
            ...
            sur ce site. Il est de votre responsabilité de consulter
            régulièrement les CGU pour vous tenir informé des éventuelles
            modifications.
          </p>
        </div>
        <div className="cgu__section">
          <h3 className="cgu__section__h3">Droit applicable :</h3>
          <p className="cgu__section__content">
            ...
            soumis à la juridiction compétente de votre pays. En utilisant ce
            site, vous acceptez de respecter ces CGU. Si vous ne les acceptez
